...
var ASM_CONSTS = {
  100307: ($0, $1) => { let text = Module.UTF8ToString($0, $1); FS.mkdir(text); FS.mount(IDBFS, {}, text); },  
 100394: ($0, $1) => { document.title = Module.UTF8ToString($0, $1); console.log(document.title); },  
 100473: () => { FS.syncfs( false, function(err) { if (err) { alert("An error occured while syncing fs", err); } else { console.log("Successfully synced"); } }); }
};
function sync_fs_from_db() { Module.timer = false; FS.syncfs( true, function(err) { if (err) { console.error("An error occured while syncing fs", err); } Module.timer = true; }); }
...
var asmLibraryArg = {
  ...
  "sync_fs_from_db": sync_fs_from_db
};
...
/** @type {function(...*):?} */
var _Unload = Module["_Unload"] = createExportWrapper("Unload");
...
var ___start_em_js = Module['___start_em_js'] = 100116;
var ___stop_em_js = Module['___stop_em_js'] = 100307;
